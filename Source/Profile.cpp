...
const ResourceProfile kResTemplateCore =
	{	"Core",						"Core",				IDR_TEXT_INI_CORE,		3	};

const ResourceProfile kResTemplateBase[] =
{//		dispName					fileName			resID					ver
	{	"ECO Base",					"ECO Base",			IDR_TEXT_INI_BASE_ECO,	4	},
	{	"EQ P99 Base",				"P99 Base",			IDR_TEXT_INI_BASE_P99,	3	},
	{	"EQ PQ Base",				"PQ Base",			IDR_TEXT_INI_BASE_PQ,	3	},
...
{//		dispName					fileName			resID					ver
#ifdef _DEBUG
	{	"EverCraft Online",			"ECO Custom",		IDR_TEXT_INI_CUST_ECO,	0	},
	{	"EverQuest: Project 1999",	"P99 Custom",		IDR_TEXT_INI_CUST_P99,	0	},
	{	"EverQuest: Project Quarm",	"PQ Custom",		IDR_TEXT_INI_CUST_PQ,	0	},
	{	"Monsters & Memories",		"MnM Custom",		IDR_TEXT_INI_CUST_MNM,	0	},
	{	"Pantheon: RotF",			"Pantheon Custom",	IDR_TEXT_INI_CUST_PAN,	0	},
#else
	{	"EverCraft Online",			"ECO",				IDR_TEXT_INI_CUST_ECO,	0	},
	...
	{	"Pantheon: RotF",			"Pantheon",			IDR_TEXT_INI_CUST_PAN,	0	},
#endif
};
...
retryQuery:
	...
	for(int i = 0; i < ARRAYSIZE(kResTemplateCustom); ++i)
	{
		...
		aTemplateProfileNames.push_back(
			kCopyResPrefix + kResTemplateCustom[i].fileName + '"');
